...
INSERT INTO `developer` (`id`, `first_name`, `last_name`, `gender`, `category`, `learned_by`, `school_attended`, `favorite_language`) VALUES (2 , 'Grace', 'Hpper', 'Female', 'Expert', 'University', 'Yale', 'Python');
